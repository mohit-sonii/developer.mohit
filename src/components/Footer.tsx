    ...
    <footer className=" bg-slate-900 w-full h-max flex gap-12 justify-center items-center">
      <main className="flex flex-col my-12 p-5 gap-10 m-auto justify-center content-center">
        ...
        <section className="flex gap-12 jusitfy-center items-center">
          <Icon
            dest="https://instagram.com/developer.mohit"
            source="/instagram.svg"
            alt="instagram icon"
          />
          <Icon
            dest="https://github.com/mohit-sonii"
            source="/github.svg"
            alt="Github icon"
          />
          <Icon
            dest="https://www.linkedin.com/in/mohit-soni-808984265/"
            source="/linkedin.svg"
            alt="Linkedin icon"
          />
          <Icon
            dest="https://bento.me/mohit-sonii"
            source="/bento.svg"
            alt="instagram icon"
          />
        </section>
        <nav
          className="flex gap-8 font-bold text-xl"
