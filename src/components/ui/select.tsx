...
>(({ className, children, ...props }, ref) => (
   <SelectPrimitive.Trigger
      ref={ref}
      className="w-full justify-center items-center gap-5 flex rounded-md outline-none p-5 border-1 border-[var(--accentColor)] text-[var(--textColor)] focus:border-[var(--textColor)] font-medium text-xl"
      {...props}
   >
      {children}
