...
export default function Education() {
   return (
      <section className="mb-5  w-[90%] py-10 grid grid-cols-1 gap-10 md:grid-cols-2 m-auto justify-center">
         <div className="flex flex-col w-full items-start gap-8 md:gap-12 justify-start">
         ...
         <div className="flex flex-col w-full  items-start md:items-end gap-8 md:gap-12 justify-normal">
